...
(define-fun get_addr ( (ROB_index (_ BitVec 6)) (ROB_done (Array (_ BitVec 6) (_ BitVec 1))) (ROB_op (Array (_ BitVec 6) Int)) (ROB_Maddress (Array (_ BitVec 6) Int)) (LSQ_op (Array (_ BitVec 3) Int)) (LSQ_Vj (Array (_ BitVec 3) Int)) (LSQ_Imm (Array (_ BitVec 3) Int)) (LSQ_ROBdst (Array (_ BitVec 3) (_ BitVec 6)))) Int
	(let
		(
			(LSQ0_op (select LSQ_op (_ bv0 3)))
			(LSQ1_op (select LSQ_op (_ bv1 3)))
			(LSQ2_op (select LSQ_op (_ bv2 3)))
			(LSQ3_op (select LSQ_op (_ bv3 3)))
			(LSQ4_op (select LSQ_op (_ bv4 3)))
			(LSQ5_op (select LSQ_op (_ bv5 3)))
			(LSQ6_op (select LSQ_op (_ bv6 3)))
			(LSQ7_op (select LSQ_op (_ bv7 3)))
			
			(LSQ0_vj (select LSQ_Vj (_ bv0 3)))
			(LSQ1_vj (select LSQ_Vj (_ bv1 3)))
			(LSQ2_vj (select LSQ_Vj (_ bv2 3)))
			(LSQ3_vj (select LSQ_Vj (_ bv3 3)))
			(LSQ4_vj (select LSQ_Vj (_ bv4 3)))
			(LSQ5_vj (select LSQ_Vj (_ bv5 3)))
			(LSQ6_vj (select LSQ_Vj (_ bv6 3)))
			(LSQ7_vj (select LSQ_Vj (_ bv7 3)))
			
			(LSQ0_Imm (select LSQ_Imm (_ bv0 3)))
			(LSQ1_Imm (select LSQ_Imm (_ bv1 3)))
			(LSQ2_Imm (select LSQ_Imm (_ bv2 3)))
			(LSQ3_Imm (select LSQ_Imm (_ bv3 3)))
			(LSQ4_Imm (select LSQ_Imm (_ bv4 3)))
			(LSQ5_Imm (select LSQ_Imm (_ bv5 3)))
			(LSQ6_Imm (select LSQ_Imm (_ bv6 3)))
			(LSQ7_Imm (select LSQ_Imm (_ bv7 3)))
			
			(LSQ0_ROBdst (select LSQ_ROBdst (_ bv0 3)))
			(LSQ1_ROBdst (select LSQ_ROBdst (_ bv1 3)))
			(LSQ2_ROBdst (select LSQ_ROBdst (_ bv2 3)))
			(LSQ3_ROBdst (select LSQ_ROBdst (_ bv3 3)))
			(LSQ4_ROBdst (select LSQ_ROBdst (_ bv4 3)))
			(LSQ5_ROBdst (select LSQ_ROBdst (_ bv5 3)))
			(LSQ6_ROBdst (select LSQ_ROBdst (_ bv6 3)))
			(LSQ7_ROBdst (select LSQ_ROBdst (_ bv7 3)))
		)
...
;---------------------------Issue------------------------
		...
		(let
			(
				...
				(issue_to_lsq7 (ite (and (= LSQ7_busy #b0) (or (= op SLoad) (= op SStore))) (_ bv1 1) (_ bv0 1)))
			)
		(let
			(
				(issue_to_rs1 (ite (and (= issue_to_rs0 #b0) (= RS1_busy #b0) (or (= op Rtype) (= op Branch))) (_ bv1 1) (_ bv0 1)))
				(issue_to_lsq6 (ite (and (= issue_to_lsq7 #b0) (= LSQ6_busy #b0) (or (= op SLoad) (= op SStore))) (_ bv1 1) (_ bv0 1)))
			)
		(let
			(
				(issue_to_rs2 (ite (and (= issue_to_rs0 #b0) (= issue_to_rs1 #b0) (= RS2_busy #b0) (or (= op Rtype) (= op Branch))) (_ bv1 1) (_ bv0 1)))
				(issue_to_lsq5 (ite (and (= issue_to_lsq6 #b0) (= issue_to_lsq7 #b0) (= LSQ5_busy #b0) (or (= op SLoad) (= op SStore))) (_ bv1 1) (_ bv0 1)))
				
			)
		(let
			(
				(issue_to_rs3 (ite (and (= issue_to_rs0 #b0) (= issue_to_rs1 #b0) (= issue_to_rs2 #b0) (= RS3_busy #b0) (or (= op Rtype) (= op Branch))) (_ bv1 1) (_ bv0 1)))
				(issue_to_lsq4 (ite (and (= issue_to_lsq5 #b0) (= issue_to_lsq6 #b0) (= issue_to_lsq7 #b0) (= LSQ4_busy #b0) (or (= op SLoad) (= op SStore))) (_ bv1 1) (_ bv0 1)))
		...
		(let
			(
				...
				(issue_to_lsq3 (ite (and (= issue_to_lsq4 #b0) (= issue_to_lsq5 #b0) (= issue_to_lsq6 #b0) (= issue_to_lsq7 #b0) (= LSQ3_busy #b0) (or (= op SLoad) (= op SStore))) (_ bv1 1) (_ bv0 1)))
			)
		(let
			(
				...
				(issue_to_lsq2 (ite (and (= issue_to_lsq3 #b0) (= issue_to_lsq4 #b0) (= issue_to_lsq5 #b0) (= issue_to_lsq6 #b0) (= issue_to_lsq7 #b0) (= LSQ2_busy #b0) (or (= op SLoad) (= op SStore))) (_ bv1 1) (_ bv0 1)))
			)
		(let
			(
				...
				(issue_to_lsq1 (ite (and (= issue_to_lsq2 #b0) (= issue_to_lsq3 #b0) (= issue_to_lsq4 #b0) (= issue_to_lsq5 #b0) (= issue_to_lsq6 #b0) (= issue_to_lsq7 #b0) (= LSQ1_busy #b0) (or (= op SLoad) (= op SStore))) (_ bv1 1) (_ bv0 1)))
			)
		(let
			(
				...
				(issue_to_lsq0 (ite (and (= issue_to_lsq1 #b0) (= issue_to_lsq2 #b0) (= issue_to_lsq3 #b0) (= issue_to_lsq4 #b0) (= issue_to_lsq5 #b0) (= issue_to_lsq6 #b0) (= issue_to_lsq7 #b0) (= LSQ0_busy #b0) (or (= op SLoad) (= op SStore))) (_ bv1 1) (_ bv0 1)))
			)
...
;---------------------------Dispatch, Broadcast and Update------------------
		...
		(let
			(
				(U2_LSQ_dis_index
					(ite (= U2_LSQ0_dis #b1) (_ bv0 3)
					(ite (= U2_LSQ1_dis #b1) (_ bv1 3)
					(ite (= U2_LSQ2_dis #b1) (_ bv2 3)
					(ite (= U2_LSQ3_dis #b1) (_ bv3 3)
					(ite (= U2_LSQ4_dis #b1) (_ bv4 3) 
					(ite (= U2_LSQ5_dis #b1) (_ bv5 3) 
					(ite (= U2_LSQ6_dis #b1) (_ bv6 3) 
					(ite (= U2_LSQ7_dis #b1) (_ bv7 3) 
					(_ bv0 3)
					)))))))) 
...
;---------------------------Commit-------------------------------------------------
		...
		(let
			(
				...
				(U4_RS_op (ite (and (= CP_U3_ROB_done #b1) (= CP_U3_ROB_op Branch) (= CP_U3_ROB_exception #b1)) empty_RS_LSQ_int U3_RS_op))
				(U4_RS_ROB_dst (ite (and (= CP_U3_ROB_done #b1) (= CP_U3_ROB_op Branch) (= CP_U3_ROB_exception #b1)) empty_RS_LSQ_3bit U3_RS_ROB_dst))
				(U4_RS_vj (ite (and (= CP_U3_ROB_done #b1) (= CP_U3_ROB_op Branch) (= CP_U3_ROB_exception #b1)) empty_RS_LSQ_int U3_RS_vj))
				(U4_RS_vk (ite (and (= CP_U3_ROB_done #b1) (= CP_U3_ROB_op Branch) (= CP_U3_ROB_exception #b1)) empty_RS_LSQ_int U3_RS_vk))
				(U4_RS_qj (ite (and (= CP_U3_ROB_done #b1) (= CP_U3_ROB_op Branch) (= CP_U3_ROB_exception #b1)) empty_RS_LSQ_3bit U3_RS_qj))
				(U4_RS_qk (ite (and (= CP_U3_ROB_done #b1) (= CP_U3_ROB_op Branch) (= CP_U3_ROB_exception #b1)) empty_RS_LSQ_3bit U3_RS_qk))
				(U4_RS_imm (ite (and (= CP_U3_ROB_done #b1) (= CP_U3_ROB_op Branch) (= CP_U3_ROB_exception #b1)) empty_RS_LSQ_int U3_RS_imm))
				(U4_RS_dis (ite (and (= CP_U3_ROB_done #b1) (= CP_U3_ROB_op Branch) (= CP_U3_ROB_exception #b1)) empty_RS_LSQ_1bit U3_RS_dis))
				(U4_RS_busy (ite (and (= CP_U3_ROB_done #b1) (= CP_U3_ROB_op Branch) (= CP_U3_ROB_exception #b1)) empty_RS_LSQ_1bit U3_RS_busy))
				
				(U4_LSQ_op (ite (and (= CP_U3_ROB_done #b1) (= CP_U3_ROB_op Branch) (= CP_U3_ROB_exception #b1)) empty_RS_LSQ_int U3_LSQ_op))
				(U4_LSQ_ROB_dst (ite (and (= CP_U3_ROB_done #b1) (= CP_U3_ROB_op Branch) (= CP_U3_ROB_exception #b1)) empty_RS_LSQ_3bit U3_LSQ_ROB_dst))
				(U4_LSQ_vj (ite (and (= CP_U3_ROB_done #b1) (= CP_U3_ROB_op Branch) (= CP_U3_ROB_exception #b1)) empty_RS_LSQ_int U3_LSQ_vj))
				(U4_LSQ_vk (ite (and (= CP_U3_ROB_done #b1) (= CP_U3_ROB_op Branch) (= CP_U3_ROB_exception #b1)) empty_RS_LSQ_int U3_LSQ_vk))
				(U4_LSQ_qj (ite (and (= CP_U3_ROB_done #b1) (= CP_U3_ROB_op Branch) (= CP_U3_ROB_exception #b1)) empty_RS_LSQ_3bit U3_LSQ_qj))
				(U4_LSQ_qk (ite (and (= CP_U3_ROB_done #b1) (= CP_U3_ROB_op Branch) (= CP_U3_ROB_exception #b1)) empty_RS_LSQ_3bit U3_LSQ_qk))
				(U4_LSQ_imm (ite (and (= CP_U3_ROB_done #b1) (= CP_U3_ROB_op Branch) (= CP_U3_ROB_exception #b1)) empty_RS_LSQ_int U3_LSQ_imm))
				(U4_LSQ_dis (ite (and (= CP_U3_ROB_done #b1) (= CP_U3_ROB_op Branch) (= CP_U3_ROB_exception #b1)) empty_RS_LSQ_1bit U3_LSQ_dis))
				(U4_LSQ_busy (ite (and (= CP_U3_ROB_done #b1) (= CP_U3_ROB_op Branch) (= CP_U3_ROB_exception #b1)) empty_RS_LSQ_1bit U3_LSQ_busy))
...
;(----------------------------General Invarint 4 RS, LSQ ()-------------------------------------------------
				...
				(=> (= #b1 (select T_RS_busy (_ bv0 3))) (and (not (= (select T_RS_ROB_dst (_ bv0 3)) (select T_RS_ROB_dst (_ bv1 3)))) (not (= (select T_RS_ROB_dst (_ bv0 3)) (select T_RS_ROB_dst (_ bv2 3)))) (not (= (select T_RS_ROB_dst (_ bv0 3)) (select T_RS_ROB_dst (_ bv3 3))))  (not (= (select T_RS_ROB_dst (_ bv0 3)) (select T_LSQ_ROB_dst (_ bv0 3)))) (not (= (select T_RS_ROB_dst (_ bv0 3)) (select T_LSQ_ROB_dst (_ bv1 3)))) (not (= (select T_RS_ROB_dst (_ bv0 3)) (select T_LSQ_ROB_dst (_ bv2 3)))) (not (= (select T_RS_ROB_dst (_ bv0 3)) (select T_LSQ_ROB_dst (_ bv3 3)))) )) ;done
				(=> (= #b1 (select T_RS_busy (_ bv1 3))) (and (not (= (select T_RS_ROB_dst (_ bv1 3)) (select T_RS_ROB_dst (_ bv0 3)))) (not (= (select T_RS_ROB_dst (_ bv1 3)) (select T_RS_ROB_dst (_ bv2 3)))) (not (= (select T_RS_ROB_dst (_ bv1 3)) (select T_RS_ROB_dst (_ bv3 3))))  (not (= (select T_RS_ROB_dst (_ bv1 3)) (select T_LSQ_ROB_dst (_ bv0 3)))) (not (= (select T_RS_ROB_dst (_ bv1 3)) (select T_LSQ_ROB_dst (_ bv1 3)))) (not (= (select T_RS_ROB_dst (_ bv1 3)) (select T_LSQ_ROB_dst (_ bv2 3)))) (not (= (select T_RS_ROB_dst (_ bv1 3)) (select T_LSQ_ROB_dst (_ bv3 3)))) )) ;done
				(=> (= #b1 (select T_RS_busy (_ bv2 3))) (and (not (= (select T_RS_ROB_dst (_ bv2 3)) (select T_RS_ROB_dst (_ bv0 3)))) (not (= (select T_RS_ROB_dst (_ bv2 3)) (select T_RS_ROB_dst (_ bv1 3)))) (not (= (select T_RS_ROB_dst (_ bv2 3)) (select T_RS_ROB_dst (_ bv3 3))))  (not (= (select T_RS_ROB_dst (_ bv2 3)) (select T_LSQ_ROB_dst (_ bv0 3)))) (not (= (select T_RS_ROB_dst (_ bv2 3)) (select T_LSQ_ROB_dst (_ bv1 3)))) (not (= (select T_RS_ROB_dst (_ bv2 3)) (select T_LSQ_ROB_dst (_ bv2 3)))) (not (= (select T_RS_ROB_dst (_ bv2 3)) (select T_LSQ_ROB_dst (_ bv3 3)))) )) ;done
				(=> (= #b1 (select T_RS_busy (_ bv3 3))) (and (not (= (select T_RS_ROB_dst (_ bv3 3)) (select T_RS_ROB_dst (_ bv0 3)))) (not (= (select T_RS_ROB_dst (_ bv3 3)) (select T_RS_ROB_dst (_ bv1 3)))) (not (= (select T_RS_ROB_dst (_ bv3 3)) (select T_RS_ROB_dst (_ bv2 3))))  (not (= (select T_RS_ROB_dst (_ bv3 3)) (select T_LSQ_ROB_dst (_ bv0 3)))) (not (= (select T_RS_ROB_dst (_ bv3 3)) (select T_LSQ_ROB_dst (_ bv1 3)))) (not (= (select T_RS_ROB_dst (_ bv3 3)) (select T_LSQ_ROB_dst (_ bv2 3)))) (not (= (select T_RS_ROB_dst (_ bv3 3)) (select T_LSQ_ROB_dst (_ bv3 3)))) )) ;done
				(=> (= #b1 (select T_RS_busy (_ bv4 3))) (and (not (= (select T_RS_ROB_dst (_ bv4 3)) (select T_RS_ROB_dst (_ bv0 3)))) (not (= (select T_RS_ROB_dst (_ bv4 3)) (select T_RS_ROB_dst (_ bv2 3)))) (not (= (select T_RS_ROB_dst (_ bv4 3)) (select T_RS_ROB_dst (_ bv2 3))))  (not (= (select T_RS_ROB_dst (_ bv4 3)) (select T_LSQ_ROB_dst (_ bv0 3)))) (not (= (select T_RS_ROB_dst (_ bv4 3)) (select T_LSQ_ROB_dst (_ bv1 3)))) (not (= (select T_RS_ROB_dst (_ bv4 3)) (select T_LSQ_ROB_dst (_ bv2 3)))) (not (= (select T_RS_ROB_dst (_ bv4 3)) (select T_LSQ_ROB_dst (_ bv3 3)))) )) ;done
				(=> (= #b1 (select T_RS_busy (_ bv5 3))) (and (not (= (select T_RS_ROB_dst (_ bv5 3)) (select T_RS_ROB_dst (_ bv0 3)))) (not (= (select T_RS_ROB_dst (_ bv5 3)) (select T_RS_ROB_dst (_ bv2 3)))) (not (= (select T_RS_ROB_dst (_ bv5 3)) (select T_RS_ROB_dst (_ bv2 3))))  (not (= (select T_RS_ROB_dst (_ bv5 3)) (select T_LSQ_ROB_dst (_ bv0 3)))) (not (= (select T_RS_ROB_dst (_ bv5 3)) (select T_LSQ_ROB_dst (_ bv1 3)))) (not (= (select T_RS_ROB_dst (_ bv5 3)) (select T_LSQ_ROB_dst (_ bv2 3)))) (not (= (select T_RS_ROB_dst (_ bv5 3)) (select T_LSQ_ROB_dst (_ bv3 3)))) )) ;done
				(=> (= #b1 (select T_RS_busy (_ bv6 3))) (and (not (= (select T_RS_ROB_dst (_ bv6 3)) (select T_RS_ROB_dst (_ bv0 3)))) (not (= (select T_RS_ROB_dst (_ bv6 3)) (select T_RS_ROB_dst (_ bv2 3)))) (not (= (select T_RS_ROB_dst (_ bv6 3)) (select T_RS_ROB_dst (_ bv2 3))))  (not (= (select T_RS_ROB_dst (_ bv6 3)) (select T_LSQ_ROB_dst (_ bv0 3)))) (not (= (select T_RS_ROB_dst (_ bv6 3)) (select T_LSQ_ROB_dst (_ bv1 3)))) (not (= (select T_RS_ROB_dst (_ bv6 3)) (select T_LSQ_ROB_dst (_ bv2 3)))) (not (= (select T_RS_ROB_dst (_ bv6 3)) (select T_LSQ_ROB_dst (_ bv3 3)))) )) ;done
				(=> (= #b1 (select T_RS_busy (_ bv7 3))) (and (not (= (select T_RS_ROB_dst (_ bv7 3)) (select T_RS_ROB_dst (_ bv0 3)))) (not (= (select T_RS_ROB_dst (_ bv7 3)) (select T_RS_ROB_dst (_ bv2 3)))) (not (= (select T_RS_ROB_dst (_ bv7 3)) (select T_RS_ROB_dst (_ bv2 3))))  (not (= (select T_RS_ROB_dst (_ bv7 3)) (select T_LSQ_ROB_dst (_ bv0 3)))) (not (= (select T_RS_ROB_dst (_ bv7 3)) (select T_LSQ_ROB_dst (_ bv1 3)))) (not (= (select T_RS_ROB_dst (_ bv7 3)) (select T_LSQ_ROB_dst (_ bv2 3)))) (not (= (select T_RS_ROB_dst (_ bv7 3)) (select T_LSQ_ROB_dst (_ bv3 3)))) )) ;done


				(=> (= #b1 (select T_LSQ_busy (_ bv0 3))) (and (= (select T_ROB_op (select T_LSQ_ROB_dst (_ bv0 3))) (select T_LSQ_op (_ bv0 3))) (= #b1 (select T_ROB_busy (select T_LSQ_ROB_dst (_ bv0 3)))) (= #b0 (select T_ROB_done (select T_LSQ_ROB_dst (_ bv0 3))))))
				(=> (= #b1 (select T_LSQ_busy (_ bv1 3))) (and (= (select T_ROB_op (select T_LSQ_ROB_dst (_ bv1 3))) (select T_LSQ_op (_ bv1 3))) (= #b1 (select T_ROB_busy (select T_LSQ_ROB_dst (_ bv1 3)))) (= #b0 (select T_ROB_done (select T_LSQ_ROB_dst (_ bv1 3))))))
				(=> (= #b1 (select T_LSQ_busy (_ bv2 3))) (and (= (select T_ROB_op (select T_LSQ_ROB_dst (_ bv2 3))) (select T_LSQ_op (_ bv2 3))) (= #b1 (select T_ROB_busy (select T_LSQ_ROB_dst (_ bv2 3)))) (= #b0 (select T_ROB_done (select T_LSQ_ROB_dst (_ bv2 3))))))
				(=> (= #b1 (select T_LSQ_busy (_ bv3 3))) (and (= (select T_ROB_op (select T_LSQ_ROB_dst (_ bv3 3))) (select T_LSQ_op (_ bv3 3))) (= #b1 (select T_ROB_busy (select T_LSQ_ROB_dst (_ bv3 3)))) (= #b0 (select T_ROB_done (select T_LSQ_ROB_dst (_ bv3 3))))))
                (=> (= #b1 (select T_LSQ_busy (_ bv4 3))) (and (= (select T_ROB_op (select T_LSQ_ROB_dst (_ bv4 3))) (select T_LSQ_op (_ bv4 3))) (= #b1 (select T_ROB_busy (select T_LSQ_ROB_dst (_ bv4 3)))) (= #b0 (select T_ROB_done (select T_LSQ_ROB_dst (_ bv4 3))))))
				(=> (= #b1 (select T_LSQ_busy (_ bv5 3))) (and (= (select T_ROB_op (select T_LSQ_ROB_dst (_ bv5 3))) (select T_LSQ_op (_ bv5 3))) (= #b1 (select T_ROB_busy (select T_LSQ_ROB_dst (_ bv5 3)))) (= #b0 (select T_ROB_done (select T_LSQ_ROB_dst (_ bv5 3))))))
				(=> (= #b1 (select T_LSQ_busy (_ bv6 3))) (and (= (select T_ROB_op (select T_LSQ_ROB_dst (_ bv6 3))) (select T_LSQ_op (_ bv6 3))) (= #b1 (select T_ROB_busy (select T_LSQ_ROB_dst (_ bv6 3)))) (= #b0 (select T_ROB_done (select T_LSQ_ROB_dst (_ bv6 3))))))
				(=> (= #b1 (select T_LSQ_busy (_ bv7 3))) (and (= (select T_ROB_op (select T_LSQ_ROB_dst (_ bv7 3))) (select T_LSQ_op (_ bv7 3))) (= #b1 (select T_ROB_busy (select T_LSQ_ROB_dst (_ bv7 3)))) (= #b0 (select T_ROB_done (select T_LSQ_ROB_dst (_ bv7 3))))))
